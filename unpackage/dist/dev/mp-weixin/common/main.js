...
{
  onLaunch: function onLaunch() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$uni$$http$get, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              console.log('App Launch,判断是否已登录');_context.next = 3;return (
  ...
  (0, _vuex.mapMutations)('m_personal', ['changeUserId', 'changeUserName', 'changeEmail', 'changeGender', 'changeAvatarUrl'])) };exports.default = _default;
